...
SPECIAL NOTE 
***************
LMD-Tools SE 7.1 and LMD-Tools SE 2012 provide a different set of components. If you rely on certain controls in your existing projects, please check first Comparison Sheet our web site, whether these are still included in LMD-Tools 2012 SE:
...
* D16 indicates Delphi XE2 (Win32, Delphi only) and B16 indicates C++ Builder XE2 release.
...
3.) The LMD 2012 releases can not be used at the same time with other LMD 200X release packages e.g. LMD-Tools 7.X (SE). Make sure you update either to latest version or use our free LMDPackUtil (http://www.lmd.de/download) utility to switch between different package settings. 
...
HKEY_CURRENT_USER\Software\LMD Innovative\LMD-Tools 2012 and
HKEY_LOCAL_MACHINE\SOFTWARE\LMD Innovative\LMD-Tools 2012
Remove them if you don't want to use LMD 2012 products any longer.
